...
export const se_ListDurableExecutionsByFunctionCommand = async (
  input,
  context,
) => {
  const b = rb(input, context);
...
export const de_ListDurableExecutionsByFunctionCommand = async (
  output,
  context,
) => {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
...
export const de_ListFunctionEventInvokeConfigsCommand = async (
  ...
  const doc = take(data, {
    FunctionEventInvokeConfigs: (_) =>
      de_FunctionEventInvokeConfigList(_, context),
    NextMarker: __expectString,
  });
  Object.assign(contents, doc);
  return contents;
...
const de_Event = (output, context) => {
  return take(output, {
    ...
    Id: __expectString,
    InvocationCompletedDetails: (_) =>
      de_InvocationCompletedDetails(_, context),
    Name: __expectString,
