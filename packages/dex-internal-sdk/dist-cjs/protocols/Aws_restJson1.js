...
const se_DeleteProvisionedConcurrencyConfigInternalCommand = async (input, context) => {
    const b = (0, core_2.requestBuilder)(input, context);
    const headers = {};
...
exports.se_DeleteProvisionedConcurrencyConfigInternalCommand = se_DeleteProvisionedConcurrencyConfigInternalCommand;
...
const de_DeleteProvisionedConcurrencyConfigInternalCommand = async (output, context) => {
    if (output.statusCode !== 204 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = (0, smithy_client_1.map)({
...
exports.de_DeleteProvisionedConcurrencyConfigInternalCommand = de_DeleteProvisionedConcurrencyConfigInternalCommand;
