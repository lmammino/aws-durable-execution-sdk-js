...
class ListEventSourcesCommand extends smithy_client_1.Command.classBuilder()
    ...
    .f(void 0, void 0)
    .ser(Aws_restJson1_1.se_ListEventSourcesCommand)
    .de(Aws_restJson1_1.de_ListEventSourcesCommand)
    .build() {
}
