...
import { ExportFunctionVersionRequest, ExportFunctionVersionResponse } from "../models/models_0";
 ...
 * @public
 *
 * The input for {@link ExportFunctionVersionCommand}.
 */
export interface ExportFunctionVersionCommandInput extends ExportFunctionVersionRequest {
}
/**
 * @public
 *
 * The output of {@link ExportFunctionVersionCommand}.
 */
export interface ExportFunctionVersionCommandOutput extends ExportFunctionVersionResponse, __MetadataBearer {
}
declare const ExportFunctionVersionCommand_base: {
    new (input: ExportFunctionVersionCommandInput): import("@smithy/smithy-client").CommandImpl<ExportFunctionVersionCommandInput, ExportFunctionVersionCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ExportFunctionVersionCommandInput): import("@smithy/smithy-client").CommandImpl<ExportFunctionVersionCommandInput, ExportFunctionVersionCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { LambdaClient, ExportFunctionVersionCommand } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, ExportFunctionVersionCommand } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
 * const client = new LambdaClient(config);
 * const input = { // ExportFunctionVersionRequest
 *   FunctionName: "STRING_VALUE", // required
 * };
 * const command = new ExportFunctionVersionCommand(input);
 * const response = await client.send(command);
 * // { // ExportFunctionVersionResponse
 ...
 * ```
 *
 * @param ExportFunctionVersionCommandInput - {@link ExportFunctionVersionCommandInput}
 * @returns {@link ExportFunctionVersionCommandOutput}
 * @see {@link ExportFunctionVersionCommandInput} for command's `input` shape.
 * @see {@link ExportFunctionVersionCommandOutput} for command's `response` shape.
 ...
 *
 */
export declare class ExportFunctionVersionCommand extends ExportFunctionVersionCommand_base {
    /** @internal type navigation helper, not in runtime. */
    protected static __types: {
        api: {
            input: ExportFunctionVersionRequest;
            output: ExportFunctionVersionResponse;
        };
        sdk: {
            input: ExportFunctionVersionCommandInput;
            output: ExportFunctionVersionCommandOutput;
        };
    };
}
