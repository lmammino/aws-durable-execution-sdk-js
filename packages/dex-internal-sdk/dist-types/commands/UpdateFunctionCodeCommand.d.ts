...
import { UpdateFunctionCodeRequest } from "../models/models_1";
 ...
 * @public
 */
export type UpdateFunctionCodeCommandInputType = Omit<UpdateFunctionCodeRequest, "FunctionZip"> & {
 ...
 */
export interface UpdateFunctionCodeCommandInput extends UpdateFunctionCodeCommandInputType {
}
/**
 * @public
 *
 ...
 * ```javascript
 * import { LambdaClient, UpdateFunctionCodeCommand } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, UpdateFunctionCodeCommand } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
