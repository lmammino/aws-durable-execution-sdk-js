...
import { PublishVersionRequest20150331 } from "../models/models_1";
 ...
 * @public
 *
 * The input for {@link PublishVersion20150331Command}.
 */
export interface PublishVersion20150331CommandInput extends PublishVersionRequest20150331 {
}
/**
 * @public
 *
 * The output of {@link PublishVersion20150331Command}.
 */
export interface PublishVersion20150331CommandOutput extends FunctionConfiguration20150331, __MetadataBearer {
}
declare const PublishVersion20150331Command_base: {
    new (input: PublishVersion20150331CommandInput): import("@smithy/smithy-client").CommandImpl<PublishVersion20150331CommandInput, PublishVersion20150331CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PublishVersion20150331CommandInput): import("@smithy/smithy-client").CommandImpl<PublishVersion20150331CommandInput, PublishVersion20150331CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { LambdaClient, PublishVersion20150331Command } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, PublishVersion20150331Command } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
 * const client = new LambdaClient(config);
 * const input = { // PublishVersionRequest20150331
 ...
 * };
 * const command = new PublishVersion20150331Command(input);
 ...
 * ```
 *
 * @param PublishVersion20150331CommandInput - {@link PublishVersion20150331CommandInput}
 * @returns {@link PublishVersion20150331CommandOutput}
 * @see {@link PublishVersion20150331CommandInput} for command's `input` shape.
 * @see {@link PublishVersion20150331CommandOutput} for command's `response` shape.
 ...
 *
 */
export declare class PublishVersion20150331Command extends PublishVersion20150331Command_base {
    /** @internal type navigation helper, not in runtime. */
    protected static __types: {
        api: {
            input: PublishVersionRequest20150331;
            output: FunctionConfiguration20150331;
        };
        sdk: {
            input: PublishVersion20150331CommandInput;
            output: PublishVersion20150331CommandOutput;
        };
    };
}
