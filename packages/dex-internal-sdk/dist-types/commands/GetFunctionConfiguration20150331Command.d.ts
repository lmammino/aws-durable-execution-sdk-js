 ...
 * @public
 *
 * The input for {@link GetFunctionConfiguration20150331Command}.
 */
export interface GetFunctionConfiguration20150331CommandInput extends GetFunctionConfigurationRequest {
}
/**
 * @public
 *
 * The output of {@link GetFunctionConfiguration20150331Command}.
 */
export interface GetFunctionConfiguration20150331CommandOutput extends FunctionConfiguration20150331, __MetadataBearer {
}
declare const GetFunctionConfiguration20150331Command_base: {
    new (input: GetFunctionConfiguration20150331CommandInput): import("@smithy/smithy-client").CommandImpl<GetFunctionConfiguration20150331CommandInput, GetFunctionConfiguration20150331CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFunctionConfiguration20150331CommandInput): import("@smithy/smithy-client").CommandImpl<GetFunctionConfiguration20150331CommandInput, GetFunctionConfiguration20150331CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { LambdaClient, GetFunctionConfiguration20150331Command } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, GetFunctionConfiguration20150331Command } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
 * const client = new LambdaClient(config);
 * const input = { // GetFunctionConfigurationRequest
 *   FunctionName: "STRING_VALUE", // required
 *   Qualifier: "STRING_VALUE",
 * };
 * const command = new GetFunctionConfiguration20150331Command(input);
 ...
 * ```
 *
 * @param GetFunctionConfiguration20150331CommandInput - {@link GetFunctionConfiguration20150331CommandInput}
 * @returns {@link GetFunctionConfiguration20150331CommandOutput}
 * @see {@link GetFunctionConfiguration20150331CommandInput} for command's `input` shape.
 * @see {@link GetFunctionConfiguration20150331CommandOutput} for command's `response` shape.
 ...
 *
 */
export declare class GetFunctionConfiguration20150331Command extends GetFunctionConfiguration20150331Command_base {
    ...
    protected static __types: {
        ...
        sdk: {
            input: GetFunctionConfiguration20150331CommandInput;
            output: GetFunctionConfiguration20150331CommandOutput;
        };
    };
}
