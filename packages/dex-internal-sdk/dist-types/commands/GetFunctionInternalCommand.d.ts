...
import { GetFunctionInternalResponse, GetFunctionRequest } from "../models/models_0";
 ...
 * @public
 *
 * The input for {@link GetFunctionInternalCommand}.
 */
export interface GetFunctionInternalCommandInput extends GetFunctionRequest {
}
/**
 * @public
 *
 * The output of {@link GetFunctionInternalCommand}.
 */
export interface GetFunctionInternalCommandOutput extends GetFunctionInternalResponse, __MetadataBearer {
}
declare const GetFunctionInternalCommand_base: {
    new (input: GetFunctionInternalCommandInput): import("@smithy/smithy-client").CommandImpl<GetFunctionInternalCommandInput, GetFunctionInternalCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFunctionInternalCommandInput): import("@smithy/smithy-client").CommandImpl<GetFunctionInternalCommandInput, GetFunctionInternalCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { LambdaClient, GetFunctionInternalCommand } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, GetFunctionInternalCommand } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
 * const client = new LambdaClient(config);
 * const input = { // GetFunctionRequest
 *   FunctionName: "STRING_VALUE", // required
 *   Qualifier: "STRING_VALUE",
 * };
 * const command = new GetFunctionInternalCommand(input);
 * const response = await client.send(command);
 * // { // GetFunctionInternalResponse
 ...
 * ```
 *
 * @param GetFunctionInternalCommandInput - {@link GetFunctionInternalCommandInput}
 * @returns {@link GetFunctionInternalCommandOutput}
 * @see {@link GetFunctionInternalCommandInput} for command's `input` shape.
 * @see {@link GetFunctionInternalCommandOutput} for command's `response` shape.
 ...
 *
 */
export declare class GetFunctionInternalCommand extends GetFunctionInternalCommand_base {
    /** @internal type navigation helper, not in runtime. */
    protected static __types: {
        api: {
            input: GetFunctionRequest;
            output: GetFunctionInternalResponse;
        };
        sdk: {
            input: GetFunctionInternalCommandInput;
            output: GetFunctionInternalCommandOutput;
        };
    };
}
