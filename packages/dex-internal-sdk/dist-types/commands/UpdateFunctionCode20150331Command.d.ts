 ...
 * @public
 *
 * The input for {@link UpdateFunctionCode20150331Command}.
 */
export interface UpdateFunctionCode20150331CommandInput extends UpdateFunctionCodeRequest20150331 {
}
/**
 * @public
 *
 * The output of {@link UpdateFunctionCode20150331Command}.
 */
export interface UpdateFunctionCode20150331CommandOutput extends FunctionConfiguration20150331, __MetadataBearer {
}
declare const UpdateFunctionCode20150331Command_base: {
    new (input: UpdateFunctionCode20150331CommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFunctionCode20150331CommandInput, UpdateFunctionCode20150331CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateFunctionCode20150331CommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFunctionCode20150331CommandInput, UpdateFunctionCode20150331CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { LambdaClient, UpdateFunctionCode20150331Command } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, UpdateFunctionCode20150331Command } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
 ...
 * };
 * const command = new UpdateFunctionCode20150331Command(input);
 ...
 * ```
 *
 * @param UpdateFunctionCode20150331CommandInput - {@link UpdateFunctionCode20150331CommandInput}
 * @returns {@link UpdateFunctionCode20150331CommandOutput}
 * @see {@link UpdateFunctionCode20150331CommandInput} for command's `input` shape.
 * @see {@link UpdateFunctionCode20150331CommandOutput} for command's `response` shape.
 ...
 *
 */
export declare class UpdateFunctionCode20150331Command extends UpdateFunctionCode20150331Command_base {
    ...
    protected static __types: {
        ...
        sdk: {
            input: UpdateFunctionCode20150331CommandInput;
            output: UpdateFunctionCode20150331CommandOutput;
        };
    };
}
