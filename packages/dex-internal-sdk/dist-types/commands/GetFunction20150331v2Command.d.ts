 ...
 * @public
 *
 * The input for {@link GetFunction20150331v2Command}.
 */
export interface GetFunction20150331v2CommandInput extends GetFunctionRequest {
}
/**
 * @public
 *
 * The output of {@link GetFunction20150331v2Command}.
 */
export interface GetFunction20150331v2CommandOutput extends GetFunctionResponse20150331, __MetadataBearer {
}
declare const GetFunction20150331v2Command_base: {
    new (input: GetFunction20150331v2CommandInput): import("@smithy/smithy-client").CommandImpl<GetFunction20150331v2CommandInput, GetFunction20150331v2CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFunction20150331v2CommandInput): import("@smithy/smithy-client").CommandImpl<GetFunction20150331v2CommandInput, GetFunction20150331v2CommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * ```javascript
 * import { LambdaClient, GetFunction20150331v2Command } from "@amzn/lambda-console-sdk-client-lambda"; // ES Modules import
 * // const { LambdaClient, GetFunction20150331v2Command } = require("@amzn/lambda-console-sdk-client-lambda"); // CommonJS import
 * const client = new LambdaClient(config);
 * const input = { // GetFunctionRequest
 *   FunctionName: "STRING_VALUE", // required
 *   Qualifier: "STRING_VALUE",
 * };
 * const command = new GetFunction20150331v2Command(input);
 ...
 * ```
 *
 * @param GetFunction20150331v2CommandInput - {@link GetFunction20150331v2CommandInput}
 * @returns {@link GetFunction20150331v2CommandOutput}
 * @see {@link GetFunction20150331v2CommandInput} for command's `input` shape.
 * @see {@link GetFunction20150331v2CommandOutput} for command's `response` shape.
 ...
 *
 */
export declare class GetFunction20150331v2Command extends GetFunction20150331v2Command_base {
    ...
    protected static __types: {
        ...
        sdk: {
            input: GetFunction20150331v2CommandInput;
            output: GetFunction20150331v2CommandOutput;
        };
    };
}
